...
public class BinaryTree {
    ...
    */
    ...
    public static int leafNodeID = 0;
    
    // Stacks for symbol nodes and operators
    public Stack<Node> stackNode = new Stack<>();
    ...
    private  Set<String> Char; //set of characters 

    private  HashMap<Integer, String> symbNum; //set of Integer

      //this method is to get symbols
      public  void getSymbols(String re) {
    ...
    //to get number of leafs
    public static int getNumberOfLeafs(){
        return leafNodeID; }
